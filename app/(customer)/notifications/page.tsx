...
function getPublicEventHref(metadata: Notification["metadata"]): string | null {
    const eventReference = metadata.eventId?.trim();
                            ...
                            <section key={date} className="space-y-3">
                                ...
                                <div className="space-y-3">
                                    {notifs.map((notification) => {
                                        ...
                                        const eventHref = getPublicEventHref(notification.metadata);

                                        return (
                                            <article
                                                key={notification.id}
                                                className={`rounded-[1.75rem] border p-4 shadow-[0_14px_34px_rgba(1,89,89,0.06)] transition-colors sm:p-5 ${notification.isRead
                                                        ? "border-(--border) bg-[linear-gradient(180deg,rgba(255,255,255,0.94),rgba(247,250,249,0.9))] dark:bg-(--surface-elevated)"
                                                        : "border-[rgba(41,179,182,0.22)] bg-[linear-gradient(180deg,rgba(41,179,182,0.08),rgba(255,255,255,0.92))] dark:bg-[linear-gradient(180deg,rgba(41,179,182,0.16),rgba(18,30,31,0.92))]"
                                                    }`}
                                            >
