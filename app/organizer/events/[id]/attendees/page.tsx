    ...
    return (
        <div className="min-h-screen bg-(--bg-secondary)">
            <div className="max-w-7xl mx-auto px-4 py-6">
                ...
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-foreground mb-2">Daftar Peserta</h1>
                    <p className="text-(--text-secondary)">Kelola daftar peserta yang telah membeli tiket event Anda.</p>
                </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                        <div className="bg-(--surface) rounded-xl p-6 shadow-sm border border-(--border)">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-sm text-(--text-muted)">Total Peserta</p>
                        ...
                        <div className="bg-(--surface) rounded-xl p-6 shadow-sm border border-(--border)">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-sm text-(--text-muted)">Pending Check-in</p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <div className="flex-1 relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-(--accent-primary) focus:border-transparent"
                                />
                            </div>
                            ...
                            <div className="flex gap-2">
                                <select
                                    ...
                                    className="px-4 py-2 border rounded-lg bg-(--surface) focus:ring-2 focus:ring-(--accent-primary)"
                                >
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-(--accent-primary) text-white rounded-lg hover:opacity-90 flex items-center gap-2 transition-colors"
                                >
                                ...
                                <table className="w-full">
                                    ...
                                    <tbody className="divide-y divide-(--border)">
                                        {attendees.map((attendee) => (
                                            <tr key={attendee.id} className="hover:bg-(--surface-hover) transition-colors">
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className="inline-block px-2 py-1 bg-(--accent-primary)/10 text-(--accent-primary) text-xs font-medium rounded">
                                                        {attendee.ticketType}
                                                    </span>
                                                </td>
                                                <td className="px-6 py-4">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="text-sm">
                                                        {attendee.isCheckedIn ? (
                                                            ...
                                                            <span className="text-(--text-muted) text-xs">Belum</span>
                                                        )}
                                                    </div>
                                                </td>
                            ...
                            <div className="px-6 py-4 border-t border-(--border) flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        ...
                                        disabled={page === 1}
                                        className="px-4 py-2 border rounded-lg hover:bg-(--surface-hover) disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                    >
                                        Sebelumnya
                                    </button>
                                    <button
                                        ...
                                        className="px-4 py-2 bg-(--accent-primary) text-white rounded-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                    >
                                        Selanjutnya
                                    </button>
                                </div>
