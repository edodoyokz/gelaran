            ...
            <div className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center">
                ...
                <section className="rounded-[calc(var(--radius-3xl)+0.5rem)] border border-(--border) bg-(--surface) p-6 shadow-(--shadow-lg) sm:p-8">
                    <div className="space-y-2">
                        <h2 className="text-2xl font-semibold text-foreground">Gate Scanner login</h2>
                    ...
                    <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                autoFocus
                            />
                            <p className="mt-1.5 text-xs text-(--text-muted)">Dapatkan kode event langsung dari organizer.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                autoComplete="name"
                            />
                            <p className="mt-1.5 text-xs text-(--text-muted)">Nama ini disimpan untuk aktivitas check-in pada perangkat ini.</p>
                        </div>
