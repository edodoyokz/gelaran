        ...
        <>
            ...
            <div className="lg:hidden fixed top-4 left-4 z-50 flex items-center gap-2">
                <button
                    ...
                    className="p-2 rounded-lg shadow-md transition-colors bg-[var(--surface)] border border-[var(--border)] text-[var(--text-primary)]"
                ...
                <>
                    ...
                    >
                        ...
                        <button
                            type="button"
                            onClick={() => setIsMobileMenuOpen(false)}
                            className="absolute top-4 right-4 p-2 rounded-lg bg-[var(--surface-hover)] text-[var(--text-primary)]"
